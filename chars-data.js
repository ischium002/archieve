...
/* 2: PIEUVRE */
{
  ...
  profile:[
    ...
    },
    {
      ...
      <p>比起称之为“未来视”，她更像一个知道哪些事不值得挣扎的人。</p>
      <p>使用限制：只能判断"能不能改"，不能知道"结果是什么"。具体怎么做、做了之后会怎样，她一无所知。所以她需要维持极广的情报网络，她需要知道究竟发生了什么。</p>
  ...
  profile:[
    {
      ...
      <p>对Pieuvre的感情从第一眼就开始了，但他选择先保留这份感情，等自己站稳了再说。</p>`
    },
    {
      num:'02', title:'火焰\nThe Flame',
...
/* 4: MÉDICI */
{
  ...
  profile:[
    ...
    },
    {
      ...
      <p>由于家传契约，与⬛︎⬛︎⬛︎一脉的交易正好轮到他执行。基于等价交易规则，这次交易最终以Médici带走交易对象的头颅，返还以对等的力量结束。没想到看起来普普通通的那颗脑袋瓜子真的很值钱。</p>
      <p>本人其实是一个才从少年期发育到青年期没多久的长生恶魔。</em></p>`
    },
    {
      num:'04', title:'着装\nOutfit',
      outfits:[
  ...
  '0-1': {
    ...
    timeline:[
      ...
      },
      {
        ...
        <p>Hesperus握住了Phorion放在床旁边的手。</p><p>他们之间有过很多种沉默，在这一次的沉默里，什么都不用再确认了。</p>`
      },
      {
        era:'后来',
        event:'战后日常',
  ...
  '2-3': {
    ...
    timeline:[
      {
        era:'相遇',
        event:'垃圾场盲盒',
        text:`<p>Médici欠Pieuvre钱，提前扣款逼她去开盲盒，给了一个垃圾场坐标，说值钱东西多。Pieuvre开到了一个漂流救生舱，里面是一个head-less，转化未完全，已经漂了半年。</p>
        <p>扫描检测，好奇心爆炸，为了记录数据把人救了，维持生命体征。Dul醒来对这个名字都不知道的人一见钟情，决定先活下去再说。</p>`
      },
      {
        era:'收留',
        event:'账单与命名',
      ...
      },
      {
        ...
        <p>Pieuvre看着Dul缩成一团，心情难以言喻。Dul警惕性还是很高的，门一开就醒了，说话还不太熟练，打手势"不好意思让你担心了"。Pieuvre说舰了一顿，转头把屏蔽模式放得更难触发。</p>`
      },
      {
        era:'转折',
        event:'火',
	...
	<div class="dialogue-line">
      ...
      },
      {
        ...
        <p>Pieuvre帮Dul查证据的过程中告知了Médici，Médici发现是大鱼，联系上Phorion；Phorion发现Pieuvre是Hesperon的网友——五个人的关系网就此全部接通，Médici是中间枢纽。</p>
        <p>最终，Dul的私仇给Pieuvre送上了政敌的把柄，被发配的队友们提供了这些年的资料，并将作为人证，帮助扳倒那个人及其派系。</p>`
      },
    ],
    vignettes:[
      {label:'对照样本', text:'Dul在观景台的酒柜里发现了Pieuvre喜欢的酒，把酒精当燃料烧掉，火焰颜色更暖。Pieuvre默默记住牌子，下次多买了两瓶，说是对照样本。零食柜里悄悄分出了Dul的那一格，两个人都没提。'},
      {label:'做饭', text:'一次捡垃圾开到一批食材，Piv说扔了可惜随手做了一顿，Dul尝了觉得"原来燃烧不同的东西味道差这么多"。后来两人一起学，本来差得不多，后来差距越来越大、Dul偷偷练习，失败品都被吃掉毁尸灭迹。等Piv意识到的时候，第一反应是真好吃，第二反应是这人学好快。最终做饭全权交给Dul，Piv负责买菜点菜吃，舰负责洗碗。买菜很适合她：砍价、拣货、顺便收情报，全是她的主场。'},  ],
  },
};
